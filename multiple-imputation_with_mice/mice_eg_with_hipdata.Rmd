---
title: "mice_eg_with_hipdata.Rmd"
...
- Which are numeric? age, oh0, oh6, ohsdiff, EQ5D0, height, weight, satisfaction, bmi, imdscore 
- Which are factor?  improve (but hasn't been formatted on propose), sex, retired, ethnic, side
- Is there any variable with missing? EQ5D0, height, weight, bmi, satisfaction, ethnic, imdscore
...
*There are nine methods available for imputing a variable: regress, pmm, truncreg, intreg, logit, ologit, mlogit, poisson and nbreg.
The order of the imputed variables is key here.
