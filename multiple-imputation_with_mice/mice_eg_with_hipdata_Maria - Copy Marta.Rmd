...
2.  Create a dummy variable/s where missing values are classifed as 1
...
varX_cat = ifelse(data$varX >= value)
...
-   m: number of multiple imputations (multiple datasets returned by the
    function). The observed data will be the same across the imputed
