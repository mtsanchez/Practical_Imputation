...
The outcome of this study: `improve` = improvement in the ohs (i.e.,
ohsdiff \> 0)
...
## 6. Imputations with mice (Multivariate Imputation by Chained Equations)
...
## 9. What to do when a statistical analysis is not compatible with with() function
