...
The pre-operative `EQ5D` contains information from 5 questions asking
about a patient's health state today, covering mobility, self-care,
usual activities, pain, and anxiety. The `EQ5D` has been converted to a
...
value (p\<0.05), your data is not completely "Missing Completely at
Random" (MCAR) and you can impute. If p\>0.05, your data might be MCAR
